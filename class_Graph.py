...
class Graph() :
    ...
    def get_IndivLinks_DataFrame(self):

        df = self.get_IndivFamily_DataFrame()
    ...
    def build_IndGraph(self):
        ...
        """
        g = {}
        df = self.get_IndivLinks_DataFrame()
        ...
        for IND1 in df.index :
            ...
            for column in df.columns :
                ...
                if not pd.isna(INDI2) :
                    g[IND1][INDI2] = self.graph_value(column)
        return g
